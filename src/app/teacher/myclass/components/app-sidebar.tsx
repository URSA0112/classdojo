import { Activity, House, Info, LayoutList, PanelLeftOpen, PersonStanding, Settings } from "lucide-react";
import {
    Sidebar,
    SidebarContent,
    SidebarGroup,
...
const items = [
    {
        ...
        links: [
            ...
            { title: "Сурагчдын лист", url: "/teacher/myclass/studentList", icon: LayoutList },
            { title: "Ангийн үйл ажиллагаа", url: "/teacher/myclass/activity", icon: Activity },
            { title: "Эцэг эхийн мэдээлэл", url: "/teacher/myclass/parents", icon: Info },
