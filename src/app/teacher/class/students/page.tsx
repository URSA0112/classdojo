                ...
                <div className="mt-1">
                  ...
                  <div className="flex justify-center">
                    <button
                      ...
                      className="flex items-center justify-center w-[110px] h-[50px] border-2 border-green-500 rounded-xl gap-2 hover:bg-green-500 hover:text-white transition-0.9 text-green-500 text-bold mt-3 cursor-pointer"
                    >
